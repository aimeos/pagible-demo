import{_ as D,L as p,a5 as S,b as V,w as s,aF as q,o as f,a as l,aG as N,af as B,d as k,ah as C,ai as I,l as w,t as o,an as P,aH as H,f as r,c as v,F as $,a7 as L,aI as F,b4 as j,aJ as R,a6 as J,r as y,V as M,e as E,I as Z,au as W,a9 as z,aN as G,aO as K,aP as Q,T as X,aQ as Y,k as b,n as c,h as x,a0 as _,m as ee,aK as T,aS as te,aR as ae,ad as le,ae as A,aL as se,aM as U}from"./index-D3wUVYJU.js";import{F as ie,H as ne,A as re}from"./ElementListItems-DQ4s-IEt.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
