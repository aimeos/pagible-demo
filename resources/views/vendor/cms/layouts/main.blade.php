...
<html class="no-js" lang="{{ cms($page, 'lang') }}" dir="{{ in_array(cms($page, 'lang'), ['ar', 'az', 'dv', 'fa', 'he', 'ku', 'ur']) ? 'rtl' : 'ltr' }}">
    <head>
        ...
        <meta http-equiv="Content-Security-Policy" content="
            ...
            connect-src 'self' https://hcaptcha.com https://*.hcaptcha.com https://aimeos.org;
            style-src 'self' 'nonce-{{ csrf_token() }}' https://hcaptcha.com https://*.hcaptcha.com;
            script-src 'self' 'nonce-{{ csrf_token() }}' https://hcaptcha.com https://*.hcaptcha.com https://aimeos.org;
        ">
