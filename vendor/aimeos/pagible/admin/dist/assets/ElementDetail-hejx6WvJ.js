import{_ as $,L as p,a3 as S,b as V,w as s,aD as q,o as f,a as l,aE as N,ad as B,d as k,af as C,ag as I,l as w,t as o,al as P,aF as H,f as r,c as v,F as D,a5 as L,aG as F,b2 as j,aH as R,a4 as J,r as y,V as M,e as E,I as Z,as as W,a7 as z,aL as G,aM as K,aN as Q,T as X,aO as Y,k as b,n as c,h as x,Z as _,m as ee,aI as T,aQ as te,aP as ae,ab as le,ac as A,aJ as se,aK as U}from"./index-vo0GHY8C.js";import{F as ie,H as ne,A as re}from"./ElementListItems-DhbqDLlF.js";const de={props:{item:{type:Object,required:!0}},emits:[],data:()=>({panel:[0,1,2],versions:{},element:{}}),setup(){return{auth:S()}},watch:{item:{immediate:!0,handler(e){!e.id||!this.auth.can("element:view")||this.$apollo.query({query:p`query ($id: ID!) {
              element(id: $id) {
                id
                bypages {
                  id
