    ...
    <v-card :prepend-icon="mdiHistory">
      ...
      <v-card-text>
        <v-timeline side="end" align="start">
          ...
          <v-timeline-item
            v-if="!loading && !((latest && isModified(latest, current)) || versions.length)"
          ...
          <v-timeline-item
            v-if="!loading && latest && isModified(latest, current)"
            dot-color="blue"
            width="100%"
            size="small"
          >
          ...
          >
            <v-card :elevation="2">
              ...
              <v-card-text>
                ...
                <div class="media-list">
                  <div
                    v-for="file of filesdiff(version.files, current.files)"
                    :key="file.id"
                    :class="file.css"
                    class="file"
                  >
